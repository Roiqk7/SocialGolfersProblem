...
| :---: | :---: | :---: | :---: | :---: | :---: |
| Small | 16 | 5 | 4 | 1 | $80 + 480 + 11.200 + 11.400$ <br> $= 23.160$ |
| Medium | 32 | 10 | 8 | 1 | $320 + 8.960 + 396.800 + 186.000$ <br> $= 592.080$ |
| Large | 64 | 20 | 16 | 2 | $1.280 + 153.600 + 13.332.480 + 4.919.040$ <br> $= 18.406.400$ |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| Small | 16 | 5 | 4 | 1 | $\binom{5}{2}\cdot \binom{16}{2}\cdot 4^2$ <br> $= 19.200$ | $\binom{16}{2}\cdot[5(4\cdot4+1)+\binom{5}{2}]$ <br> $= 11.400$ |
| Medium | 32 | 10 | 8 | 1 | $\binom{10}{2}\cdot \binom{32}{2}\cdot 8^2$ <br> $= 1.428.480$ | $\binom{32}{2}\cdot[10(4\cdot8+1)+\binom{10}{2}]$ <br> $= 186.000$ |
| Large | 64 | 20 | 16 | 2 | $\binom{20}{3}\cdot \binom{64}{2}\cdot 16^3$ <br> $= 9.413.591.040$ | $\binom{64}{2}\cdot[20(4\cdot16+1)+\binom{20}{3}]$ <br> $= 4.919.040$ |
